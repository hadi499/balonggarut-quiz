  ...
  <footer class="bg-slate-900 border-t border-slate-800 pt-16 pb-8">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 mb-12">
        <div class="space-y-4">
          <h3 class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-purple-400">Balonggarut Quiz</h3>
          <p class="text-sm text-slate-400 leading-relaxed max-w-xs">
            Platform e-learning interaktif modern untuk meningkatkan kualitas belajar melalui kuis yang menantang dan menyenangkan.
          </p>
        </div>
        <div>
          ...
          <ul class="space-y-2 text-sm text-slate-400">
            ...
            <li><a href="/quizzes" class="hover:text-indigo-400 transition-colors">Daftar Kuis</a></li>
            <li><a href="/login" class="hover:text-indigo-400 transition-colors">Masuk</a></li>
            <li><a href="/register" class="hover:text-indigo-400 transition-colors">Daftar Akun</a></li>
          </ul>
        </div>
        <div>
